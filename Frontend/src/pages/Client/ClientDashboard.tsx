      ...
      <div style={{ marginLeft: '280px', flex: 1, padding: '32px' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr', gap: '16px', marginBottom: '40px' }}>
            {[
              { icon: <Calendar size={32} style={{ color: '#5B62B3' }} />, label: 'Book Service', path: '/client/services' },
              { icon: <BookOpen size={32} style={{ color: '#5B62B3' }} />, label: 'Browse Courses', path: '/client/courses' },
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '32px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
              ...
              <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', borderRadius: '16px', backgroundColor: 'white', padding: '48px', boxShadow: '0 2px 8px rgba(0,0,0,0.05)', border: '2px dashed #e2e8f0' }}>
                  ...
                  <button onClick={() => navigate('/client/services')} style={{ padding: '10px 24px', backgroundColor: '#5B62B3', color: 'white', border: 'none', borderRadius: '12px', fontSize: '14px', fontWeight: 700, cursor: 'pointer' }}>
                    Browse Services
                  </button>
                </div>
              </div>
              ...
              <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', borderRadius: '16px', backgroundColor: 'white', padding: '48px', boxShadow: '0 2px 8px rgba(0,0,0,0.05)', border: '2px dashed #e2e8f0' }}>
                  ...
                  <button onClick={() => navigate('/client/courses')} style={{ padding: '10px 24px', backgroundColor: '#f1f5f9', color: '#111', border: 'none', borderRadius: '12px', fontSize: '14px', fontWeight: 700, cursor: 'pointer' }}>
                    Explore Academy
                  </button>
                </div>
              </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
              ...
              <div style={{ borderRadius: '16px', backgroundColor: 'white', padding: '32px', boxShadow: '0 2px 8px rgba(0,0,0,0.05)', border: '1px solid #f1f5f9', position: 'relative', overflow: 'hidden' }}>
                ...
                <div style={{ marginBottom: '16px' }}>
                  ...
                  <div style={{ width: '100%', height: '6px', backgroundColor: '#f1f5f9', borderRadius: '9999px', overflow: 'hidden' }}>
                    <div style={{ width: '10%', height: '100%', backgroundColor: '#5B62B3', borderRadius: '9999px' }} />
                  </div>
              ...
              {services.length > 0 && (
                <div>
                  <h3 style={{ fontSize: '18px', fontWeight: 700, color: '#111', marginBottom: '24px', fontFamily: 'Syne, sans-serif' }}>
                    Recommended for You
                  </h3>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                    {services.map((service) => (
                      <div
                        ...
                        style={{ display: 'flex', alignItems: 'center', gap: '16px', borderRadius: '12px', backgroundColor: 'white', padding: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.05)', border: '1px solid #f1f5f9', cursor: 'pointer' }}
                      >
                        <div style={{ width: '64px', height: '64px', flexShrink: 0, borderRadius: '8px', backgroundImage: `url(${getImageUrl(service.imageUrl)})`, backgroundSize: 'cover', backgroundPosition: 'center' }} />
                        <div style={{ flex: 1 }}>
                          <h5 style={{ fontSize: '14px', fontWeight: 700, color: '#111', margin: '0 0 4px 0' }}>{service.title}</h5>
                          <div style={{ display: 'flex', alignItems: 'center', gap: '4px', marginBottom: '4px' }}>
                            <Star size={14} style={{ color: '#fbbf24', fill: '#fbbf24' } as any} />
                            <span style={{ fontSize: '11px', fontWeight: 700, color: '#64748b' }}>4.9 (124)</span>
                          </div>
                          <p style={{ fontSize: '14px', fontWeight: 700, color: '#111', margin: 0 }}>Rs. {service.price?.toLocaleString()}</p>
                        </div>
                      </div>
                    ))}
                  </div>
          ...
          <div style={{ marginTop: '64px', display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '32px', paddingTop: '40px', borderTop: '1px solid #e2e8f0' }}>
            {[
              ...
              { icon: <Sparkles size={24} style={{ color: '#94a3b8' }} />, value: '50', label: 'Loyalty Points' },
