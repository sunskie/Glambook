...
import {
  Store, CalendarCheck, BookOpen, DollarSign,
  ...
  const sections: SettingsSection[] = [
    {
      title: 'Account',
      items: [
        { icon: Store, label: 'Business Profile', desc: 'Update your salon information',
          onClick: () => navigate('/vendor/profile') },
        { icon: CalendarCheck, label: 'Manage Bookings', desc: 'View and handle client bookings',
          onClick: () => navigate('/vendor/bookings') },
        { icon: BookOpen, label: 'Manage Courses', desc: 'Create and manage your courses',
          onClick: () => navigate('/vendor/courses') },
        { icon: DollarSign, label: 'Earnings & Payments', desc: 'Track your revenue and commissions',
    ...
    },
    {
      title: 'Legal',
      items: [
        { icon: FileText, label: 'Terms & Conditions', desc: 'Platform terms and vendor policies',
